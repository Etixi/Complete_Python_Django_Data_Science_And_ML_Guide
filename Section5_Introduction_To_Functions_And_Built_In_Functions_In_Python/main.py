...
print("============== Using the Return Statement in Functions ================")
def multiply_numbers(a, b):
    result = a * b
    return result


result_of_multiplication = multiply_numbers(15,55)
print(result_of_multiplication)

print("============== Using the built-in dir() Function ================")
print(dir())
print(__name__)
print(__builtins__)
...
print("============== Gathering User input built-in input() Function ================")
