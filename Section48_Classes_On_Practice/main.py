...
# Now you should NOT search posts like that. Use find_posts_by_autthor!
#print(forum.posts[0].title)
#print(forum.posts[0].content)
#print(forum.posts[0].author.username)
#print(forum.posts[0].author.email)

print(forum.find_user_by_username('admin12'))
print(forum.find_user_by_username('bogdan123').email)
